...
const GraduateStudies = () => {
    ...
    const programCodesMenuItems = graduateStudiesData.program_codes.map(({program_code, curriculum_id}) => (<MenuItem key={curriculum_id} value={curriculum_id}>{program_code}</MenuItem>)) || <MenuItem>No program codes found</MenuItem>;;
    ...
    const subjectCodesMenuItems = graduateStudiesData?.subject_codes?.map(({subject_code, added}, index) => {
        return (<MenuItem key={index} value={subject_code}>{added ? `${subject_code}(added)`: subject_code}</MenuItem>)
    ...
    return (
        ...
        >
            <Typography>MANAGE GRADUATE STUDIES</Typography>
            <Box
                sx={{
                    display: 'flex',
                ...
                component="form"
                onSubmit={addSubjectCodeHandler}
            >
                <FormControl fullWidth>
                    ...
                    <Select
                        ...
                        value={graduateStudiesData.select.program_code}
                        label="Program Code"
